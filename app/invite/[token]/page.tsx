            ...
            <div className="w-full max-w-md flex flex-col gap-6">
                {invite.email && (
                    <div className="text-center text-sm text-muted-foreground bg-secondary/30 p-4 rounded-xl border border-secondary shadow-sm">
                        Hello <span className="font-medium text-foreground">{invite.email}</span>, <span className="font-medium text-foreground">{invite.creator.name}</span> is inviting you to {isProductInvite ? "purchase this pack" : "connect"}.
                    </div>
                )}
                ...
                {isProductInvite ? (
                    ...
                    <Card className="shadow-xl border-0">
                        <CardHeader>
                            ...
                            <CardDescription>
                                <span className="font-medium text-foreground">{invite.creator.name}</span> has invited you to connect.
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
