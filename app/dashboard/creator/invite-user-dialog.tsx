...
import { IconMailPlus, IconCopy, IconCheck } from "@tabler/icons-react"
...
export function InviteUserDialog({ open: controlledOpen, onOpenChange: controlledOnOpenChange, defaultPackId, trigger }: InviteUserDialogProps) {
